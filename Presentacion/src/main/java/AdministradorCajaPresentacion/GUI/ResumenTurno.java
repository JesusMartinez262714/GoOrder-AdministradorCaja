...
public class ResumenTurno extends JFrame {
    ...
    private void initComponents() {
        ...
        lblNombreSesion = new JLabel("Sesión Actual: Jesus Martinez");
        ...
        lblTituloDinamico = new JLabel("Resumen de Ventas del Turno de Juan Leonel.");
        ...
        JPanel pnlGrid = new JPanel(new GridLayout(2, 3, 25, 25));
        pnlGrid.setOpaque(false);

        lblEfectivo = new JLabel("$4,250.00");
        lblApp = new JLabel("$2,100.00");
        lblTarjeta = new JLabel("$1,550.00");
    ...
    public void cargarDatos(resumenVentasDTO resumen, List<cajeroDTO> cajeros, String nombreSupervisor) {
        ...
        if (resumen != null) {
            ...
            cajeroDTO seleccionado = (cajeroDTO) cmbCajeros.getSelectedItem();
            lblTituloDinamico.setText("Resumen de Ventas del Turno de " +
                    (seleccionado != null ? seleccionado.getNombreCompleto() : "---") + ".");
        }
    }
